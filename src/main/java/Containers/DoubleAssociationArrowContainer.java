...
public class DoubleAssociationArrowContainer extends AbstractArrowContainer {
	...
	public DoubleAssociationArrowContainer(ClassContainer to, ClassContainer from, String toCardinality, String fromCardinality) {
