...
public class DoubleDependencyArrowContainer extends AbstractArrowContainer {
	...
	public DoubleDependencyArrowContainer(ClassContainer to, ClassContainer from, String toCardinality, String fromCardinality) {
