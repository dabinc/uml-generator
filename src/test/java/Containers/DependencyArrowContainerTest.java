...
public class DependencyArrowContainerTest {

	@Test
	public void testRender() {
		Renderer renderer = Mockito.mock(Renderer.class);
		DependencyArrowContainer toTest = new DependencyArrowContainer(Mockito.mock(ClassContainer.class), Mockito.mock(ClassContainer.class));
		Mockito.when(renderer.renderDependencyArrowContainer(toTest)).thenReturn("testValue");
	...
	public void testDependencyArrowContainerCreation() {
		...
		DependencyArrowContainer toTest = new DependencyArrowContainer(to, from);
		...
		toTest = new DependencyArrowContainer(to, from, "toCardinality");
		...
		toTest = new DependencyArrowContainer(to, from, "toCardinality", "fromCardinality");
